...
export default function DashboardLayout() {
  ...
  return (
    <div className="h-screen overflow-hidden bg-gradient-to-br from-slate-50 via-gray-50 to-blue-50/30">
      ...
      <aside className={`fixed top-0 bottom-0 left-0 z-40 w-72 h-screen bg-gradient-to-b from-slate-900 via-slate-900 to-slate-800 transform transition-all duration-300 ease-out lg:translate-x-0 flex flex-col ${sidebarOpen ? 'translate-x-0' : '-translate-x-full'}`} style={{ overflow: 'hidden' }}>
        ...
        <div className="shrink-0 px-4 pt-4">
          <div className={`p-4 bg-white/5 rounded-2xl border border-white/10 hover:bg-white/10 transition-all duration-300 cursor-pointer group ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '100ms' }}>
        ...
        <nav className="flex-1 p-4 space-y-1.5 overflow-hidden min-h-0">
        ...
        <div className={`shrink-0 p-4 border-t border-white/10 bg-slate-900 transition-all duration-500 ${mounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: '400ms' }}>
          <button
