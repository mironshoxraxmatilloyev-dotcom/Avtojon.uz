      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
        ...
        <div className="grid grid-cols-2 divide-x divide-slate-100">
          <div className="p-3 flex items-center gap-2.5">
            ...
            <div>
              <p className="text-slate-800 font-bold text-base leading-none">{stats?.totalCompletedTrips || 0}</p>
              <p className="text-slate-400 text-xs">Tugatilgan</p>
            </div>
          </div>
          <div className="p-3 flex items-center gap-2.5">
            ...
            <div className="min-w-0">
              <p className="text-slate-800 font-bold text-base leading-none truncate">+{formatMoney(stats?.totalBonusAmount || 0)}</p>
            ...
            {recentFlights.map((flight) => (
              ...
              >
                <div className={`w-9 h-9 rounded-lg flex items-center justify-center flex-shrink-0 ${
                  ...
                  <MapPin size={16} className={flight.status === 'completed' ? 'text-emerald-600' : 'text-amber-600'} />
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-2 text-xs text-slate-400">
                    ...
                    {flight.profit > 0 && (
                      <span className="text-emerald-600 font-medium">+{formatMoney(flight.profit)}</span>
                    )}
                  </div>
                </div>
