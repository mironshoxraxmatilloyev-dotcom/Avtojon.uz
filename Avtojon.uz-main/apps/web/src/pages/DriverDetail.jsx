      ...
      <div className="relative overflow-hidden bg-gradient-to-r from-slate-900 via-blue-900 to-slate-900 text-white p-8 rounded-3xl">
        ...
        <div className="relative">
          ...
          <button 
            ...
            className="mb-6 flex items-center gap-2 text-blue-300 hover:text-white transition group"
          >
          ...
          <div className="flex flex-col md:flex-row md:items-center gap-6">
            {/* Avatar */}
            <div className="relative">
              <div className="w-24 h-24 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-3xl flex items-center justify-center text-4xl font-bold shadow-2xl shadow-blue-500/30">
                {driver.fullName?.charAt(0) || 'S'}
              </div>
              <div className={`absolute -bottom-2 -right-2 w-8 h-8 bg-gradient-to-br ${currentStatus.color} rounded-xl flex items-center justify-center shadow-lg`}>
                <StatusIcon size={16} />
              </div>
            </div>
            ...
            <div className="flex-1">
              <div className="flex items-center gap-3 mb-2">
                <h1 className="text-3xl md:text-4xl font-bold">{driver.fullName}</h1>
                <div className="flex items-center gap-1 px-3 py-1 bg-amber-500/20 rounded-full">
                  <Star size={14} className="text-amber-400 fill-amber-400" />
                  <span className="text-amber-300 text-sm font-medium">Pro</span>
                </div>
              </div>
              <p className="text-blue-300 text-lg">@{driver.username}</p>
              <div className="flex items-center gap-2 mt-3">
                <span className={`px-4 py-2 bg-gradient-to-r ${currentStatus.color} rounded-xl text-sm font-semibold shadow-lg flex items-center gap-2`}>
                  <StatusIcon size={16} />
                  {currentStatus.label}
                </span>
                <span className="px-4 py-2 bg-white/10 rounded-xl text-sm text-blue-200">
            ...
            <div className="flex gap-4">
              <div className="text-center px-6 py-4 bg-white/10 backdrop-blur rounded-2xl border border-white/10">
                <p className="text-3xl font-bold">{completedTrips.length}</p>
                <p className="text-blue-300 text-sm">Reyslar</p>
              </div>
              <div className="text-center px-6 py-4 bg-white/10 backdrop-blur rounded-2xl border border-white/10">
                <p className="text-3xl font-bold text-emerald-400">{formatMoney(totalEarnings)}</p>
                <p className="text-blue-300 text-sm">Jami daromad</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white rounded-3xl shadow-sm border border-gray-100 p-6">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-xl font-bold text-gray-900">Moliyaviy statistika</h2>
                <p className="text-gray-500 text-sm">Oylik hisobot</p>
              </div>
            </div>

            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              <div className="group p-5 bg-gradient-to-br from-blue-50 to-indigo-50 rounded-2xl border border-blue-100 hover:shadow-lg hover:shadow-blue-500/10 transition-all">
                ...
                <p className="text-2xl font-bold text-gray-900">{formatMoney(driver.baseSalary)}</p>
                <p className="text-sm text-gray-500">Oylik maosh</p>
              </div>

              <div className="group p-5 bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl border border-purple-100 hover:shadow-lg hover:shadow-purple-500/10 transition-all">
                <div className="w-10 h-10 bg-purple-500 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
                  <Route size={20} className="text-white" />
                </div>
                <p className="text-2xl font-bold text-gray-900">{formatMoney(totalPayment)}</p>
                <p className="text-sm text-gray-500">Reys haqlari</p>
              </div>

              <div className="group p-5 bg-gradient-to-br from-emerald-50 to-teal-50 rounded-2xl border border-emerald-100 hover:shadow-lg hover:shadow-emerald-500/10 transition-all">
                ...
                <p className="text-2xl font-bold text-emerald-600">+{formatMoney(totalBonus)}</p>
                <p className="text-sm text-gray-500">Bonuslar</p>
              </div>

              <div className="group p-5 bg-gradient-to-br from-red-50 to-rose-50 rounded-2xl border border-red-100 hover:shadow-lg hover:shadow-red-500/10 transition-all">
                <div className="w-10 h-10 bg-red-500 rounded-xl flex items-center justify-center mb-3 group-hover:scale-110 transition-transform">
            ...
            {/* Total Earnings Bar */}
            <div className="mt-6 p-5 bg-gradient-to-r from-slate-900 to-slate-800 rounded-2xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-3xl font-bold text-white">{formatMoney(totalEarnings)} <span className="text-lg text-slate-400">so'm</span></p>
                  </div>
                </div>
